...
export default function LicenciamentoAcreditacaoPage() {
    ...
    const steps = [
        {
            title: "Solicitação",
            description: "Submeta o requerimento com a documentação necessária à ANEP.",
        ...
        {
            title: "Vistoria",
            description: "Uma equipe multidisciplinar realizará uma inspeção das instalações.",
            icon: <Users className="w-6 h-6 text-[#003B71]"/>
        },
        {
            title: "Aprovação",
            description: "Após aprovação, você receberá o Alvará e o Certificado de Acreditação.",
                ...
                <section className="relative py-24 bg-gradient-to-r from-[#003B71] to-[#0056a4]">
                    ...
                    >
                        ...
                        <p className="text-xl mb-8 max-w-2xl mx-auto">
                            Garanta a excelência e o reconhecimento oficial da sua instituição de educação profissional
                            através do licenciamento da ANEP.
                        </p>
                        <Button
                            color="primary"
                            size="lg"
                ...
                <section className="py-24 px-4 bg-gray-50">
                    <div className="max-w-7xl mx-auto max-w-5xl">
                        <motion.div
                            ...
                            transition={ { duration: 0.8 } }
                        >
                            <h2 className="text-4xl font-bold text-center mb-16">Processo de Licenciamento e
                                Acreditação</h2>
                                ...
                                <div>
                                    { steps.map((step, index) => (
                                        <div key={ index } className="flex mb-8">
                                            <div
                                                className="flex-shrink-0 w-12 h-12 rounded-full bg-[#003B71] text-white flex items-center justify-center text-xl font-bold">
                                                { index + 1 }
                                            </div>
                                            <div className="ml-4">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <Card className="bg-white shadow-lg">
                                    <CardBody>
                                        ...
                                        <p className="text-gray-600">Até 18 meses após a autorização de criação da
                                            instituição</p>
                                    </CardBody>
                                </Card>
                                <Card className="bg-white shadow-lg">
                                    <CardBody>
                                        ...
                                        <p className="text-gray-600">6 meses a partir da data de depósito do
                                            processo</p>
                                    </CardBody>
                                </Card>
                            </div>
                    ...
                    <div className="max-w-7xl mx-auto max-w-5xl">
                        ...
                        >
                            ...
                            <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
                                Inicie o processo de licenciamento e acreditação da sua instituição de educação
                                profissional hoje. Nossa equipe está pronta para guiá-lo em cada etapa do processo.
                            </p>
