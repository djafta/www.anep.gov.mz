    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <main>
                    ...
                    <div className="max-w-6xl mx-auto px-4">
                        <div className="text-center max-w-4xl mx-auto">
                            ...
                            <p className="text-xl text-gray-500 mb-12 leading-relaxed">
                                Promovendo a excelência na educação profissional em Moçambique através de padrões
                                rigorosos,
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
                            <div>
                                ...
                                <p className="text-gray-600 text-lg leading-relaxed mb-8">
                                    A ANEP é responsável por gerir e supervisionar o sistema de educação profissional em
                                    Moçambique,
                                    garantindo que os programas educacionais atendam às necessidades do mercado de
                                    trabalho e
                ...
                <section id="qualifications" className="py-32 bg-gray-50">
                    <div className="max-w-7xl mx-auto px-4">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl font-bold text-gray-900 mb-4">Áreas de Qualificação</h2>
                            <p className="text-gray-600 max-w-2xl mx-auto">
                                Oferecemos qualificações profissionais em diversas áreas, todas alinhadas com as
                                necessidades do mercado e padrões internacionais.
                            </p>
                        </div>
                ...
                <section id="servicos" className="py-32">
                    <div className="max-w-7xl mx-auto px-4">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-gray-600 max-w-2xl mx-auto">
                                Oferecemos uma gama completa de serviços para apoiar o desenvolvimento
                                da educação profissional em Moçambique.
                            </p>
                        </div>
                            ...
                            { [
                                {
                                    ...
                                    description: 'Sistema integrado de registro e certificação de qualificações profissionais, garantindo reconhecimento nacional e internacional.',
                                    features: [
                                ...
                                },
                                {
                                    ...
                                    description: 'Processos rigorosos de avaliação e monitoramento para assegurar a excelência na educação profissional.',
                                    features: [
                                ...
                                },
                                {
                                    ...
                                    description: 'Gestão e distribuição de recursos para o desenvolvimento e melhoria contínua da educação profissional.',
                                    features: [
                ...
                {/* Contact Section */ }
                <section id="contato" className="py-32 bg-gray-50">
                    <div className="max-w-7xl mx-auto px-4">
                        <div className="text-center max-w-2xl mx-auto">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">Entre em Contato</h2>
                            <p className="text-gray-600 mb-8">
                                Nossa equipe está disponível para ajudar com suas dúvidas sobre educação profissional,
                                certificações e processos de acreditação.
                            </p>
                            <Button
                                as={ Link }
                                href="/contact"
