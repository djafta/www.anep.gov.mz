...
export function Header() {
  ...
  return (
    <Navbar className="py-2 px-0 static" height={44} maxWidth="full" onMenuOpenChange={setIsMenuOpen}>
      <NavbarContent>
        <NavbarBrand>
          <Link href={"/"}>
      ...
      <NavbarContent className="hidden md:flex gap-4" justify="center">
        <NavbarItem>
          <Link as={NextLink} className="text-gray-600 hover:text-gray-900 text-sm font-medium" href="#">
            Sobre
          </Link>
        </NavbarItem>
        <NavbarItem>
      ...
      <NavbarMenu>
        <NavbarMenuItem>
          <Link as={NextLink} className="w-full text-gray-600 hover:text-gray-900" href="#" size="lg">
            Sobre
          </Link>
        </NavbarMenuItem>
        <NavbarMenuItem>
        ...
        <NavbarMenuItem>
          <Link as={NextLink} className="w-full text-gray-600 hover:text-gray-900" href="/signin" size="lg">
            Entrar
          </Link>
        </NavbarMenuItem>
      </NavbarMenu>
