...
import { ContactFormModal } from "@/app/about/contact-form-modal";
...
export default function SobrePage() {
    ...
    const timelineEvents = [
        ...
        { year: 2018, event: "Revolução Digital", description: "Lançamento da plataforma digital de certificação" },
        {
            year: 2021,
            ...
            <main className="overflow-hidden">
                <section
                    ...
                    >
                        ...
                        <p className="text-xl mb-8 max-w-2xl mx-auto">A ANEP está na vanguarda da inovação educacional,
                            preparando profissionais para os desafios do amanhã.</p>
                        <MissionModal/>
                    </motion.div>
                        ...
                        >
                            ...
                            <div className="grid md:grid-cols-3 gap-12">
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-600">Comprometidos com os mais altos padrões em educação
                                        profissional.</p>
                                </div>
                                <div className="text-center">
                                    <div className="mb-6 inline-block p-4 bg-[#003B71] rounded-full">
                                    ...
                                    <p className="text-gray-600">Pioneiros em métodos de ensino e tecnologias
                                        educacionais avançadas.</p>
                                </div>
                                <div className="text-center">
                                    <div className="mb-6 inline-block p-4 bg-[#003B71] rounded-full">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    <p className="text-gray-600">Formando profissionais preparados para desafios
                                        globais.</p>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="max-w-7xl mx-auto max-w-5xl">
                        ...
                        >
                            ...
                            <div className="relative">
                                <div
                                    className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-[#003B71]"></div>
                                { timelineEvents.map((event, index) => (
                                    <div key={ index }
                                        ...
                                        <div
                                            className="absolute left-1/2 transform -translate-x-1/2 w-6 h-6 bg-[#003B71] rounded-full mt-2 border-4 border-white"></div>
                                    </div>
                                )) }
                            </div>
                        </motion.div>
                    ...
                    <div className="max-w-7xl mx-auto max-w-5xl">
                        ...
                        >
                            ...
                            <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
                                A ANEP tem transformado vidas e impulsionado o desenvolvimento econômico através da
                    ...
                    <div className="max-w-7xl mx-auto max-w-5xl">
                        ...
                        >
                            ...
                            <p className="text-xl mb-12 max-w-3xl mx-auto">
                                Seja parte da transformação da educação profissional. Juntos, podemos construir um
                                futuro mais qualificado e próspero para todos.
                            </p>
                            <ContactFormModal/>
                        </motion.div>
                    </div>
