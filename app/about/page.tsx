  ...
  const timelineEvents = [
    {
      ...
      description:
        "Estabelecimento da Autoridade Nacional de Educação Profissional",
    },
    {
      year: 2012,
      event: "Lançamento do Quadro Nacional de Qualificações",
      description:
        "Implementação do primeiro sistema unificado de qualificações",
    },
    {
      year: 2015,
    ...
    },
    {
      ...
      description:
        "Iniciativa focada em habilidades emergentes e tecnologias futuras",
    },
  ];
        ...
        <section className="relative h-screen flex items-center justify-center bg-gradient-to-r from-[#003B71] to-[#0056a4]">
          ...
          >
            <h1 className="text-6xl font-bold mb-6">
              Moldando o Futuro da Educação Profissional
            </h1>
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              A ANEP está na vanguarda da inovação educacional, preparando
              profissionais para os desafios do amanhã.
            </p>
            <MissionModal />
          </motion.div>
              ...
              <div className="grid md:grid-cols-3 gap-12">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Comprometidos com os mais altos padrões em educação
                    profissional.
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Pioneiros em métodos de ensino e tecnologias educacionais
                    avançadas.
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Formando profissionais preparados para desafios globais.
                  </p>
                </div>
              </div>
            </motion.div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <h4 className="text-lg font-medium mb-2 text-[#003B71]">
                          {event.event}
                        </h4>
          ...
          <div className="max-w-7xl mx-auto max-w-5xl">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
                A ANEP tem transformado vidas e impulsionado o desenvolvimento
                econômico através da educação profissional de excelência.
              </p>
              <div className="grid md:grid-cols-4 gap-8">
                <div>
                  <h3 className="text-4xl font-bold text-[#003B71] mb-2">
                    500+
                  </h3>
          ...
          <div className="max-w-7xl mx-auto max-w-5xl">
            ...
            >
              ...
              <p className="text-xl mb-12 max-w-3xl mx-auto">
                Seja parte da transformação da educação profissional. Juntos,
                podemos construir um futuro mais qualificado e próspero para
                todos.
              </p>
              <ContactFormModal />
            </motion.div>
