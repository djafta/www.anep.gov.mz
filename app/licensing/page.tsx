...
export default function LicenciamentoAcreditacaoPage() {
  ...
  const creationSteps = [
    ...
    },
    {
      title: "Aprovação",
      description:
        `Após aprovação da tutela, receberá a transcrição do despacho de criação. <span class="font-bold">O despacho de criação não autoriza a instituição criada a funcionar.</span>`,
  ...
  const licensingSteps = [
    ...
    },
    {
      title: "Vistoria",
      description:
        "Uma equipe multidisciplinar realizará uma vistoria às instalações.",
      icon: <Users className="w-6 h-6 text-[#003B71]"/>,
    },
    {
      title: "Aprovação",
      description:
        "Após aprovação, receberá o Alvará e o Certificado de Acreditação.",
      icon: <CheckCircle className="w-6 h-6 text-[#003B71]"/>,
    },
    {
          ...
          <div className=" mx-auto max-w-7xl">
            ...
            >
              ...
              <div
                ...
                <div
                  className={ "before:absolute before:border-l before:h-[90%] before:w-full before:max-w-7xl before:left-[calc(50%+1.5rem)] before:top-0 before:-translate-x-1/2 before:translate-y-10 before:border-[#003B71] relative" }>
                  <div
                    className="flex flex-col justify-center p-4 gap-2 w-full h-24 bg-white rounded-3xl shadow-lg my-10 relative border border-[#003B71]">
                    <h3 className="text-lg font-bold">Criação</h3>
                    <p className={ "text-gray-600 text-sm" }>O processo de criação torna-o ilegível ao processo de
                      início de funcionamento / renovação.</p>
                  </div>
                  { creationSteps.map((step, index) => (
                    <div key={ index } className="flex mb-8">
                      <div
                        className="flex-shrink-0 w-12 h-12 rounded-full bg-[#003B71] text-white flex items-center justify-center text-xl font-bold z-10">
                        { index + 1 }
                      </div>
                      <div className="ml-4">
                  ...
                  <div
                    className="flex flex-col justify-center p-4 gap-2 h-24 bg-white rounded-3xl shadow-lg my-10 relative border border-[#003B71]">
                    <h3 className="text-lg font-bold">Início de funcionamento / Renovação do alvará ou C.
                      acreditação</h3>
                    <p className={ "text-gray-600 text-sm" }>Este processo o autoriza a iniciar as atividades na sua
