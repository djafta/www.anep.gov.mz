...
export function Header() {
  ...
  return (
    <Navbar className="py-2 px-0" height={44} maxWidth="full" onMenuOpenChange={setIsMenuOpen}>
      <NavbarContent>
        <NavbarBrand>
          <Link href={"/"}>
      ...
      <NavbarMenu>
        ...
        <NavbarMenuItem>
          <Link as={NextLink} className="w-full text-gray-600 hover:text-gray-900" href="/sign-up" size="lg">
            Criar conta
          </Link>
        </NavbarMenuItem>
      </NavbarMenu>
